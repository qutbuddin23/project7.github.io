...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-white.webp");
    ...
    jQuery(".skin-3").on('click',function(){
		...
		jQuery(".logo-dark img").attr("src", "images/logo-3.webp");
		jQuery(".logo-white img").attr("src", "images/logo-white.webp");
        return false;
    });
	...
	var currentURL      = window.location.href; 
	if(currentURL.indexOf('index-2.html') > -1){
