		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.site-header .container > .logo-header .logo-3').attr('src','images/logo-3.webp');
				} else {
					menu.removeClass('is-fixed');
					$('.site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3').attr('src','images/logo-white.webp')
				}
			}
		});
